...
export const installationBodyFallback: Record<"cubarama" | "captain_godfrey" | "drift", string> = {
  ...
  captain_godfrey: [
    ...
    "Captain Godfrey AI is a real-time interactive digital human — a MetaHuman figure animated live by artificial intelligence. His voice was recorded and cloned from a human performer. His character is built from the marine inquiry transcript, from Marcia van Zeller's historical research in The Capes, and from the firsthand passenger account of George Leake. He is not playing back recordings. Every conversation is different.",
    "Voice and likeness provided by a human performer. Character informed by the Busselton marine inquiry transcript (December 1876), The Capes by Marcia van Zeller (Curtin University, 2014), and the letters of George Leake (Battye Library of Western Australian History).",
  ].join("\n\n"),
  drift: [
