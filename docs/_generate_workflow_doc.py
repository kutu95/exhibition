...
SECTIONS: list[tuple[str, list[str]]] = [
    ...
    (
        ...
        [
            ...
            "   • Checkout uses inline Stripe pricing from each variant’s price_aud (no Stripe product catalog to maintain).",
    ...
    (
        ...
        [
            ...
            "• GOOGLE_OAUTH_TOKEN_PATH and GOOGLE_DRIVE_FOLDER_ID — for automatic personal Drive delivery",
            "• LOCAL_OUTPUT_DIR — required retained local copy of every print file",
            ...
            "6. Copy to LOCAL_OUTPUT_DIR/<order>_<slug>/ and, when personal Drive OAuth is configured, upload every size ordered of that photograph into one Google Drive folder named <order>_<slug>, with unlisted anyone-with-link reader access.",
    ...
    (
        ...
        [
            ...
            "Stripe misconfigured — checkout fails if STRIPE_SECRET_KEY / publishable key / webhook secret are wrong for the current mode.",
