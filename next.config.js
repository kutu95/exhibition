...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "margies.app",
        pathname: "/**",
      },
      {
        protocol: "https",
        hostname: "www.margies.app",
        pathname: "/**",
      },
    ],
  },
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(self), geolocation=()" },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://storage.margies.app https://exhibition.margies.app https://margies.app https://www.margies.app",
              "media-src 'self' blob:",
